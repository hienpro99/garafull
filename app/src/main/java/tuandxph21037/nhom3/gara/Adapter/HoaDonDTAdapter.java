...
public class HoaDonDTAdapter extends ArrayAdapter<HoaDon> implements Filterable {
    private Context context;
    DoanhSoNhanVien fragment;
    ...
    public HoaDonDTAdapter(@NonNull Context context, DoanhSoNhanVien fragment, ArrayList<HoaDon> list) {
